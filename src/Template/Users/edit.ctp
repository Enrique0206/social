                   ...
                   <div class="panel panel-default">   
                        ...
                        <?=$this->Form->create($user)?>			
                            <div class="form-group">
                                <h5><?=$this->Form->control('username', ['class' => 'form-control'])?></h5>     					
                            </div>
                            <div class="form-group">
                                <h5><?=$this->Form->control('password',  ['class' => 'form-control'])?></h5>      					
                            </div>  
                            <div class="form-group">
                                <h5><?=$this->Form->control('fullname', ['class' => 'form-control'])?></h5>      					
                            </div>
                            <div class="form-group">
                        ...
                        <div class="panel-footer">
                            <div class="btn-toolbar">
                              ...
                              <?= $this->Html->link('Cancel', ['action' => 'add'], ['class' => 'btn btn-default'])?>
                            </div>
                        </div>       
